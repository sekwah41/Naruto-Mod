...
public class PlayerPoseAnimatorOld {

    public static JSONObject poses;
    private static JSONObject poseData;
    private boolean jsonLoaded = false;

    public PlayerPoseAnimatorOld() { // make this loaded on startup
        // TODO add some code to fetch the pose data from dropbox if possible so players don't cheat
        InputStream filestreamJson = PlayerPoseAnimatorOld.class.getResourceAsStream("/assets/narutomod/mod/poseData.json");
