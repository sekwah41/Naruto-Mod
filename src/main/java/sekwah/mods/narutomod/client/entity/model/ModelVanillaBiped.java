...
public class ModelVanillaBiped extends ModelBiped {
    ...
    public ModelVanillaBiped() {
        this(0.0F);
    }

    public ModelVanillaBiped(float par1) {
        this(par1, 0.0F, 64, 32);
    }

    public ModelVanillaBiped(float par1, float par2, int par3, int par4) {
