...
public class ItemNinjaSword extends Item {
    ...
    public ItemNinjaSword(ToolMaterial par2EnumNinjaToolMaterial) {
        super();
     ...
     * sword
     */
    public float getStrVsBlock(Block par2Block) {
    ...
    public boolean canHarvestBlock(Block par1Block) {
        return par1Block.getMaterial() == Blocks.web.getMaterial();
    }
