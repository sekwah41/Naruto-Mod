...
import sekwah.mods.narutomod.common.items.itemmodels.ModelMadaraChestplate;
...
public class ItemArmourShinobiChestplate extends ItemArmor {
    ...
    public ItemArmourShinobiChestplate(ArmorMaterial par2EnumArmorMaterial,
                                       int par3, int par4) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        return NarutoMod.modid + ":textures/armour/shinobiChestplate.png";
    }
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving,
        ...
        ModelMadaraChestplate armorModel = null;
        if (itemStack != null) {
            if (itemStack.getItem() instanceof ItemArmourShinobiChestplate) {
                int type = ((ItemArmor) itemStack.getItem()).armorType;

                if (type == 1) {
                    armorModel = new ModelMadaraChestplate(); // change to the flak jacket model
