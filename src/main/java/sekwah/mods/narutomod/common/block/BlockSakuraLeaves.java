...
import sekwah.mods.narutomod.common.entity.particles.EntitySakuraPetalFX;
...
public class BlockSakuraLeaves extends BlockLeavesBase implements IShearable {
    ...
    public void randomDisplayTick(World par1World, int x, int y, int z, Random par5Random) {
        if (par1World.isRainingAt(x, y + 1, z) && !World.doesBlockHaveSolidTopSurface(par1World, x, y - 1, z) && par5Random.nextInt(15) == 1) {
