package com.sekwah.mods.narutomod.worldgeneration;
...
public class WorldGenBigSakuraTree extends WorldGenerator {
    ...
    // void genTreeLayer or func_150529_a
        ...
        for (aint1[par5] = aint[par5]; j1 <= i1; ++j1) {
            ...
            while (k1 <= i1) {
                ...
                if (d0 > (double) (par4 * par4)) {
                    ...
                    if (block != null &&
                            !block.isAir(worldObj, aint1[0], aint1[1], aint1[2]) &&
    ...
    void generateLeafNode(int par1, int par2, int par3) {
        ...
        for (int i1 = par2 + this.leafDistanceLimit; l < i1; ++l) {
            ...
            this.genTreeLayer(par1, l, par3, f, (byte) 1, NarutoBlocks.Sakura_Leaves);
        }
    }
    ...
    boolean validTreeLocation() {
        ...
        boolean isValidSoil = (block != null && block.canSustainPlant(worldObj, basePos[0], basePos[1] - 1, basePos[2], ForgeDirection.UP, (BlockSapling) Blocks.sapling));
        if (!isValidSoil) {
            return false;
        } else {
