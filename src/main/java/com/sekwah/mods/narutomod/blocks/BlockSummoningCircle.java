...
import com.sekwah.mods.narutomod.packets.clientbound.ClientSoundPacket;
...
public class BlockSummoningCircle extends Block {
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4) {
        return par3 >= 255 ? false : par1World.doesBlockHaveSolidTopSurface(par1World, par2, par3 - 1, par4) && super.canPlaceBlockAt(par1World, par2, par3, par4) && super.canPlaceBlockAt(par1World, par2 + 1, par3, par4) && super.canPlaceBlockAt(par1World, par2, par3, par4 + 1) && super.canPlaceBlockAt(par1World, par2 - 1, par3, par4) && super.canPlaceBlockAt(par1World, par2, par3, par4 - 1) && super.canPlaceBlockAt(par1World, par2 - 1, par3, par4 - 1) && super.canPlaceBlockAt(par1World, par2 + 1, par3, par4 - 1) && super.canPlaceBlockAt(par1World, par2 - 1, par3, par4 + 1) && super.canPlaceBlockAt(par1World, par2 + 1, par3, par4 + 1) && par1World.doesBlockHaveSolidTopSurface(par1World, par2 + 1, par3 - 1, par4) && par1World.doesBlockHaveSolidTopSurface(par1World, par2, par3 - 1, par4 + 1) && par1World.doesBlockHaveSolidTopSurface(par1World, par2 - 1, par3 - 1, par4) && par1World.doesBlockHaveSolidTopSurface(par1World, par2, par3 - 1, par4 - 1) && par1World.doesBlockHaveSolidTopSurface(par1World, par2 - 1, par3 - 1, par4 - 1) && par1World.doesBlockHaveSolidTopSurface(par1World, par2 + 1, par3 - 1, par4 - 1) && par1World.doesBlockHaveSolidTopSurface(par1World, par2 - 1, par3 - 1, par4 + 1) && par1World.doesBlockHaveSolidTopSurface(par1World, par2 + 1, par3 - 1, par4 + 1);
    }
