package com.sekwah.mods.narutomod.entitys.projectiles;
...
public class CopyOfEntityShuriken extends Entity implements IProjectile {
    /**
    ...
    public CopyOfEntityShuriken(World par1World) {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    }

    public CopyOfEntityShuriken(World par1World, double par2, double par4, double par6) {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public CopyOfEntityShuriken(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5) {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public CopyOfEntityShuriken(World par1World, EntityLivingBase par2EntityLivingBase, EntityLiving par3EntityLiving, float par4, float par5) {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
    ...
    public CopyOfEntityShuriken(World par1World, EntityLivingBase par2EntityLivingBase, float par3) {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
    ...
    public void onUpdate() {
        ...
        if (var16 != Blocks.air) {
            ...
            AxisAlignedBB axisalignedbb = var16.getCollisionBoundingBoxFromPool(this.worldObj, this.xTile, this.yTile, this.zTile);
        ...
        if (this.inGround) {
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    // TODO uncomment if you decide to re-add the kunai in player
                    /**if (movingobjectposition.entityHit instanceof EntityPlayer && this.ticksInAir > 20)
                     {
                     movingobjectposition.entityHit.getDataWatcher().updateObject(24, movingobjectposition.entityHit.getDataWatcher().getWatchableObjectInt(24) + 1);
                     }*/
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(var21, k)) {
                        ...
                        this.playSound("narutomod:ninjasounds.effects.Kunai_thud", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
