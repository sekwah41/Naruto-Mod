package com.sekwah.mods.narutomod.entitys.renderers.projectiles;
...
public class RenderExplosiveKunai extends Render {
    private static final ResourceLocation entityTexture = new ResourceLocation("narutomod:textures/entitys/Explosivekunai_entity.png");

    public void renderExplosiveKunai(EntityExplosiveKunai par1Entity, double par2, double par4, double par6, float par8, float par9) {
        ...
        float var21 = (float) par1Entity.arrowShake - par9;
    ...
    protected ResourceLocation entityTexture(EntityExplosiveKunai par1Entity) {
        return entityTexture;
    }

    protected ResourceLocation getEntityTexture(Entity par1Entity) {
        return this.entityTexture((EntityExplosiveKunai) par1Entity);
    }
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        this.renderExplosiveKunai((EntityExplosiveKunai) par1Entity, par2, par4, par6, par8, par9);
    }
}