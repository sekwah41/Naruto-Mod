package com.sekwah.mods.narutomod.entitys;
...
import com.sekwah.mods.narutomod.entitys.ai.EntityAIFollowMaster;
...
public class EntityShadowClone extends EntityMob {
    ...
    public EntityShadowClone(World par1World) {
        ...
        this.targetTasks.addTask(1, new com.sekwah.mods.narutomod.entitys.ai.EntityAIOwnerHurtByTarget(this));
        this.targetTasks.addTask(2, new com.sekwah.mods.narutomod.entitys.ai.EntityAIOwnerHurtTarget(this));
