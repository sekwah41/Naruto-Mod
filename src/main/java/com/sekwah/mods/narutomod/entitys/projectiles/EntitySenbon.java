...
public class EntitySenbon extends EntityArrow implements IProjectile {
    /**
    ...
    public EntitySenbon(World par1World, EntityLivingBase par2EntityLivingBase, EntityLiving par3EntityLiving, float par4, float par5) {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float) k)) {
                        ...
                        this.playSound("narutomod:effects.Needle_hit", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer) {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0) {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(NarutoItems.senbon, 1))) {
                var2 = false;
            }
