...
public class ModelRetexturedBox extends ModelBox {
    ...
    public ModelRetexturedBox(ModelRenderer par1ModelRenderer, int par2, int par3, float par4, float par5, float par6, int par7, int par8, int par9, float par10, int topX, int topY, int botX, int botY) {
