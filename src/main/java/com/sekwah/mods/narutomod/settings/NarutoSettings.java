...
public class NarutoSettings {
    ...
    public static void preInit(FMLPreInitializationEvent event) {
        ...
        Property configUsageReportMode = config.get(Configuration.CATEGORY_GENERAL, "usageReportMode", 0);
        usageReportMode = configUsageReportMode.getInt(0);
        configUsageReportMode.comment = "This sets the usage report mode 0 = Enabled, 1 = No data sent but says its " +
