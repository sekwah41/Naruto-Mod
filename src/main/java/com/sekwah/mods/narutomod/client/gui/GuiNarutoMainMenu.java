...
import com.sekwah.mods.narutomod.network.UpdateChecker;
...
public class GuiNarutoMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public static void forgeMainMenuMessage(GuiNarutoMainMenu guiNarutoMainMenu, FontRenderer font, int width, int height) {
        ...
        if (status == BETA || status == BETA_OUTDATED) {
            ...
            guiNarutoMainMenu.drawString(font, line, (width - font.getStringWidth(line)) / 2, 4 + (0 * (font.FONT_HEIGHT + 1)), -1);
            line = I18n.format("forge.update.beta.2");
            guiNarutoMainMenu.drawString(font, line, (width - font.getStringWidth(line)) / 2, 4 + (1 * (font.FONT_HEIGHT + 1)), -1);
        }
        ...
        if (line != null) {
            ...
            guiNarutoMainMenu.drawString(font, line, width - font.getStringWidth(line) - 2, height - (2 * (font.FONT_HEIGHT + 1)), -1);
        }
    }
    ...
    public void initGui() {
        ...
        } else if (calendar.get(2) + 1 == 11 && calendar.get(5) == 2) {
            this.splashText = "Happy birthday, SEKWAH41!";
        } else if (calendar.get(2) + 1 == 1 && calendar.get(5) == 7) {
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        //forgeMainMenuMessage(this, fontRendererObj, width, height);
